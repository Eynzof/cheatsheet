...
export const FlexBlockSix = [...Array(6)].map((e, i) => i).map((i) => <div className={styles.atom} key={i}
                                                                             style={{backgroundColor: `rgba(33, 255, 214, ${1 - i * 0.07})`, width: '6px', height: '6px'}}></div>)

export const FlexBlockBaseline = [...Array(6)].map((e, i) => i).map((i) => <div className={styles.atom} key={i}
                                                                           style={{backgroundColor: `rgba(33, 255, 214, ${1 - i * 0.07})`, width: '6px', height: `${(i+1)*6}px`}}></div>)
export const FlexBlockTenFixed = [...Array(10)].map((e, i) => i).map((i) => <div className={styles.atom} key={i}
                                                                                 style={{backgroundColor: `rgba(33, 255, 214, ${1 - i * 0.07})`, width: '6px', height: '6px'}}></div>)
